	...
	win.FlickrMoreMenus.prototype = {
		...
		localiser: new FlickrLocaliser({
				'en-us' : {
					...
					'contact_explore' : 'Your Contacts Explore'
				},
				'fr-fr' : {
					...
					'contact_explore' : 'Explore de vos Contacts'
				},
				'it-it' : {
		...
		initStatic: function() {
			if(this.userId) {
				...
				this.insertItem('http://www.drewmyersphoto.net/cie','candy_nav_menu_explore','Calendar',this.localiser.localise('contact_explore'),false,false);
