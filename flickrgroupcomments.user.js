		...
		findMessages: function(rss,link,num) {
			...
			if(cnt==1) {
				...
				for(var i=messArray.length-1;i>=0;i--)
					mess += "<li style=\"background-image: url(../images/dotted.gif); background-repeat: repeat-x; background-position: left bottom;padding-left: 1em;padding-bottom:1em;\">"+messArray[i]+"</li>";
				mess += "</ul>";
			}
			return mess;
		},
